...
"""
This is not a fully baked solution, it was not developed by developers, and is not supported by Esri Support Services.
This script uses the ArcGIS REST API and was provided in response to an ArcREST enhancement request
http://resources.arcgis.com/en/help/arcgis-rest-api/index.html#//02r300000054000000
https://github.com/Esri/ArcREST/issues/13
...
BEFORE TESTING, GO HERE: http://www.esri.com/software/arcgis/arcgisonline/credits
Example usage:
