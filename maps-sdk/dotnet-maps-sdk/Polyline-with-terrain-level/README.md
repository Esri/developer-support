...
### Terrain-Following Route

![Terrain Following Route](images/terrain-following-route.png)

_Example route generated by clicking terrain locations in a 3D SceneView._
...
This sample is provided for educational and demonstration purposes.

Please review the ArcGIS Maps SDK for .NET licensing requirements before deploying commercial applications.
